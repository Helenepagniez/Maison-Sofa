            ...
            <div className="container" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '3rem', marginBottom: '3rem' }}>
                ...
                <div>
                    ...
                    <ul style={{ listStyle: 'none', padding: 0 }}>
                        ...
                        <li style={{ marginBottom: '0.8rem' }}><Link to="/checkout" style={{ color: '#ccc', textDecoration: 'none', transition: 'color 0.3s' }} onMouseOver={e => e.target.style.color = 'var(--color-accent)'} onMouseOut={e => e.target.style.color = '#ccc'}>Mon Panier</Link></li>
